...
<div class="space-y-6">
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        <div>
            <h1 class="text-2xl font-semibold text-gray-900">Tipos de Exame</h1>
            <p class="mt-2 text-sm text-gray-700">Gerencie os tipos de exames disponíveis na sua clínica</p>
        </div>
    ...
    <div class="bg-white shadow overflow-hidden sm:rounded-lg">
                        ...
                        <div class="flex items-start justify-between">
                            <div class="flex-1">
                                <div class="flex items-center mb-2">
                                    <div class="w-3 h-3 rounded-full mr-3" style="background-color: {{ $examType->color }}"></div>
                                    <h3 class="text-lg font-semibold text-gray-900">{{ $examType->name }}</h3>
                                </div>
                                
                                @if($examType->description)
                                    <p class="text-sm text-gray-600 mb-3">{{ $examType->description }}</p>
                                @endif
        ...
        @else
            ...
            <div class="text-center py-12">
                ...
                <h3 class="mt-2 text-sm font-medium text-gray-900">Nenhum tipo de exame</h3>
                <p class="mt-1 text-sm text-gray-500">Comece criando o primeiro tipo de exame.</p>
                <div class="mt-6">
                    <a href="{{ route('admin.exam-types.create') }}" 
